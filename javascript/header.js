 ...
 * @Last modified time: 2025-06-05T12:22:34+02:00
 */
	...
	<div class="dropdown-2" style="margin-top: 5px; margin-bottom: 5px;">
		<button class="dropbtn-2"><i class="fa fa-duotone fa-people-group fa-2x" style="font-size: 2.1em; margin-left: -4px;"></i></button>
			<div class="dropdown-content-2">
				...
				<a href="memoria_crisp.html" style="height: 68px;">memória</a>
...
<li style="width: 0px;">
	<div class="dropdown-2">
		<button class="dropbtn-2"><i class="fa fa-regular fa-podcast fa-2x"></i></button>
			<div class="dropdown-content-2">
...
<li>
	<div class="dropdown-2">
		<button class="dropbtn-2"><i class="fa fa-solid fa-database fa-2x"></i></button>
			<div class="dropdown-content-2">
				<a href="dados.html" style="height: 68px;">repositório de dados</a>
